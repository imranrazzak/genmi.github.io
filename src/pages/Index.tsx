      ...
      <section className="py-20 bg-genmi-50/50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <NewsCard id="1" title="Many Congratulations to Xinlin Zhuang and Yulong Li!" summary="Many congratulations to Xinlin Zhuang for receiving ACL best theme paper and Yulong Li for ACM MM dataset track. Their exceptional research contributions continue to advance our field and bring recognition to the GENMI Lab." date="2025-08-01" imageUrl="/src/assets/party-crackers-celebration.jpg" featured={true} hot={true} index={0} />
            <NewsCard id="2" title="OphNet-3D Dataset Released - First Extensive RGB-D Dynamic 3D Reconstruction Dataset for Ophthalmic Surgery" summary="OphNet-3D is the first extensive RGB-D dynamic 3D reconstruction dataset for ophthalmic surgery, comprising 41 sequences from 40 surgeons and totaling 7.1 million frames, with fine-grained annotations of 12 surgical phases, 10 instrument categories, dense MANO hand meshes, and full 6-DoF instrument poses." date="2023-05-15" imageUrl="/lovable-uploads/c787d3ab-3850-4562-a843-ff91940ce691.png" index={1} />
            <NewsCard id="3" title="New Publication in Nature Digital Medicine" summary="Our team's groundbreaking work on 'A Cross Population Study of Retinal Aging Biomarkers with Longitudinal Pre-training and Label Distribution Learning' has been published in Nature Digital Medicine." date="22 May 2025" index={2} />
          </div>
        </div>
      </section>
